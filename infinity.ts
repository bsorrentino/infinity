...
!function(window, Math, $) {
  ...
  var infinity:TSInfinity = new TSInfinity;
  var oldInfinity:TSInfinity = window.infinity;

  window.infinity = infinity;

  var config:Config = infinity.config;
  ...
  function updateItemPosition(items, positionChange, offset = 0) {
  ...
  function updateStartIndex(listView, prepended?: boolean) {
  ...
  function convertToItem(listView, possibleItem, prepend?: boolean) {
    var item;
